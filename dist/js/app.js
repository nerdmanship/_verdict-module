...
var verdictModule = {
  ...
  animate: function animate() {
    ...
    if (this.isChrome || this.isTouch) {
      ...
      tl.hero.add("hero").add(tl.left.play(), 1.5).add(tl.right.play(), 1.5).add(tl.interface.play(), "hero =+2");
    }
