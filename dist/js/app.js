...
// Main
tlMain.add(reset).add(tl.cam.play(), 0).add(tl.title.play(), 0).add(tl.arena.play(), 3).add(tl.hero.play(), 14.8);

// Sub-Level 1
tl.cam.set(view, { attr: { viewBox: logoPos } }).to(view, 3, { rotation: -1, transformOrigin: "center", attr: { viewBox: arenaPos }, ease: Power3.easeInOut }, 4).to(view, 2.7, { rotation: 2, transformOrigin: "center", attr: { viewBox: fightPos }, ease: Back.easeInOut }, 7).to(view, 1.3, { rotation: 0, transformOrigin: "center", attr: { viewBox: clockPos }, ease: Power3.easeInOut }, 9.7).to(view, 2.5, { rotation: 1, transformOrigin: "center", attr: { viewBox: followPos }, ease: Power1.easeInOut }, 11).to(view, 2.5, { rotation: 0, transformOrigin: "center", attr: { viewBox: heroPos }, ease: Power4.easeInOut }, 13.5).to(view, 1, { rotation: 3, transformOrigin: "center", attr: { viewBox: interfacePos }, ease: Back.easeOut }, 18.5)

// zoom in to white and fade out everything
.to(view, 2, { rotation: 0, transformOrigin: "center", attr: { viewBox: featuresPos }, ease: Power4.easeInOut }, 25.5).set(view, { attr: { viewBox: logoPos }, ease: Power4.easeInOut }, 28);
